...
- [Area_Under_the_Normal_Curve](https://github.com/ChenOnline/APEX_WVC/blob/main/Area_Under_the_Normal_Curve_WVC.ipynb) Addition of visualization of probability in a normal distribution. Need to clean up Gemini generated code. S. Chen
...
- [Hypothesis_Test_1_Proportion](https://github.com/ChenOnline/APEX_WVC/blob/main/Hypothesis_Testing_1Proportion_WVC.ipynb) Hypothesis Test for 1 Proportion, using Ken Brown's flight data. Adpated from SJSU APEX module for mean, by S. Chen.

- [Confidence_interval_2_population_proportions](https://github.com/ChenOnline/APEX_WVC/blob/main/Confidence_Interval_2_population_proportions_WVC.ipynb) Adapted by S. Chen to teach CI for 2 proportions using K. Brown's flight data, from SJSU APEX module.

- [Hypothesis_Test_Comparing_2_Population_Proportions](https://github.com/ChenOnline/APEX_WVC/blob/main/Hypothesis_Testing_2Proportions_WVC.ipynb) HT Comparing 2 Population Proportions, using Ken Brown's flight data set. Adapted from SJSU APEX HT comparing 2 means module, by S. Chen

- [Paired_Samples_t_Inference](https://github.com/ChenOnline/APEX_WVC/blob/main/accord_Paired_Samples_t_Inference_WVC.ipynb) Added a CI at the end, with questions to compare the conclusions from the HT and CI. - S. Chen

- [ANOVA](https://github.com/ChenOnline/APEX_WVC/blob/main/ANOVA_WVC.ipynb) Addition of boxplots towards the end of the module to help students visualize MPG differences among regions. Modified by K. Jachanich.
